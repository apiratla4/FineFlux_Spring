...
public interface CustomerHistoryService {
    ...
    Page<CustomerHistoryResponse> listByOrg(String organizationId, Pageable pageable);
    Page<CustomerHistoryResponse> listByOrgToday(String organizationId, Pageable pageable);
    Page<CustomerHistoryResponse> listByOrgLastWeek(String organizationId, Pageable pageable);
    Page<CustomerHistoryResponse> listByOrgMonth(String organizationId, Pageable pageable);
    Page<CustomerHistoryResponse> listByOrgDateRange(String organizationId, Instant from, Instant to, Pageable pageable);
